  ...
  const postMutation = useMutation({
    ...
    onError: (error) => {
      toast({
        ...
        description:
          error.message || "There was an error publishing your post.",
        variant: "destructive",
      });
    },
  });
                          ...
                          <img
                            ...
                            onError={(e) => {
                              (e.target as HTMLImageElement).src =
                                "https://placehold.co/600x400/EEE/999?text=Image+Preview";
                            }}
                          />
                        </div>
                      )}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-2">
                      Supports Markdown formatting (headers, lists, links, code
                      blocks, etc.)
                    </p>
                    <FormMessage />
                  </FormItem>
