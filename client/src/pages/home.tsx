...
const Home = () => {
  ...
  const getTagsForPost = (_postId: number) => {
      ...
      <section className="relative h-80 md:h-96 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white max-w-3xl">
            Blue-Tech: Share Your Knowledge
          </h1>
          <p className="mt-4 text-lg text-white/80 max-w-2xl">
            Explore articles on programming, web development, design, and more
            from talented developers around the world.
          </p>
